      ...
      <div className="container" data-aos="fade-up">
        ...
        <div className="mb-8 w-full" data-aos="fade-up" data-aos-delay="100">
          <iframe
            ...
            src="https://www.google.com/maps?q=경기도+성남시+분당구+판교동+618-5번지+B01호&output=embed&zoom=18"
            allowFullScreen
            loading="lazy"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8" data-aos="fade-up" data-aos-delay="200">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="info-item flex items-center mb-10" data-aos="fade-up" data-aos-delay="300">
              <div className="flex-shrink-0 !text-contrast text-[20px] w-[44px] h-[44px] flex justify-center items-center rounded transition-all duration-300 me-[15px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <select
                    id="brand"
                    name="brand"
                    className="form-control w-full p-[10px_15px] border border-[#e0e0e0] rounded-none text-[14px] !bg-white focus:border-[#ffc451] focus:outline-none transition-colors duration-300"
                    required
                  >
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={6}
                    className="form-control w-full p-[10px_15px] border border-[#e0e0e0] rounded-none text-[14px] !bg-white focus:border-[#ffc451] focus:outline-none transition-colors duration-300 resize-y"
                ...
                {/* 개인정보 동의 */}
                <div className="md:col-span-2">
                  <div className="privacy-box p-4 border border-[#e0e0e0] rounded-none !bg-white">
                    <p className="font-bold mb-2 text-[14px] !text-heading">개인정보를 보호를 위한 이용자 동의서</p>
                ...
                <div className="md:col-span-2">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-[#ffc451] text-[#312f2f] border-0 py-[12px] px-[30px] transition-all duration-300 rounded-none font-semibold text-[16px] hover:bg-[#ffb832] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? "전송 중..." : "문의하기"}
                  </button>
                </div>
